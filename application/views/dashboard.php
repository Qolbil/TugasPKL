...
<div id="header">
  <h1><a href="dashboard.html">
    <?php echo ($this->ion_auth->is_admin())? 'admin' : 'bukan admin'; ?></a></h1>
</div>
<!--close-Header-part--> 
...
<?php echo ($this->ion_auth->is_admin())? 'admin' : 'bukan admin'; ?>
        <?php echo $this->session->userdata('username') ?></span></a></li>
    <li class=" dropdown" id="menu-messages"><a href="#" data-toggle="dropdown" data-target="#menu-messages" class="dropdown-toggle"><i class="icon icon-envelope"></i> <span class="text">Messages</span> <span class="label label-important">5</span> <b class="caret"></b></a>
      <ul class="dropdown-menu">
        <?php if ($this->ion_auth->is_admin()){ ?><li><a class="sAdd" title="" href="#">new message</a></li><?php } ?>
    ...
    <li class=""><a title="" href="<?php echo base_url('index.php/page/logout') ?>"> <i class="icon icon-share-alt"></i> <span class="text">logout</span></a></li>
  </ul>
</div>
<div id="search">
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a><ul>
    ...
    <li> <a href="<?php echo base_url('index.php/page/quisioner') ?>"><i class="icon icon-inbox"></i> <span>Quisioner</span></a> </li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="<?php echo base_url('index.php/page/front') ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a></div>
  </div>
